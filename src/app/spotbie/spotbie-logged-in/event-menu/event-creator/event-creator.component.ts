...
import {EventCreatorService} from '../../../../services/spotbie-logged-in/event-menu/event-creator/event-creator.service';
...
export class EventCreatorComponent implements OnInit {
  ...
  eventCreatorFormUp = false;
  eventFormSubmitted = false;
  eventUploadImage = '../../assets/images/home_imgs/find-places-to-eat.svg';
  eventMediaMessage = 'Upload event Image';
  eventMediaUploadProgress = 0;
  ...
  calculateDollarValue() {
    ...
    const itemPrice = this.eventValue;
  ...
  private eventMediaUploadFinished(httpResponse: any): void {
    ...
    } else console.log('eventMediaUploadFinished', httpResponse);
